...
import com.example.mobilrental.helper.DataHelper;
...
public class SewaMobilActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView tanggal, tanggalsewa;
    RadioGroup promo;
    RadioButton weekday, weekend;
    Button selesai;

    String sNama, sAlamat, sNo, sMerk, sLama, sTanggal;
    double dPromo;
    ...
    private TextView txtTanggalSewa, etTanggalSewa;
    ...
    private void showDateDialog(){
        ...
        datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
             ...
             txtTanggalSewa.setText(dateFormat.format(newDate.getTime()));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tanggal = findViewById(R.id.txtTglSewa);
        tanggalsewa = findViewById(R.id.etTglSewa);
        ...
        txtTanggalSewa = (TextView) findViewById(R.id.txtTglSewa);
        etTanggalSewa = (TextView) findViewById(R.id.etTglSewa);
